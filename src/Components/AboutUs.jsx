...
function AboutUs() {
  return (
    <div id="AboutUs" className='w-screen h-fit flex justify-center items-center'>
                ...
                <div className='h-full w-full md:w-3/4 flex flex-col items-center py-[4em] px-[2em] gap-4'>
                      ...
                      <div className=' flex-col flex gap-2 w-full'>
                        <h1 className='bg-slate-800  px-4 py-[1em] text-[1.4em] font-Poppins tracking-widest font-black text-slate-100'>KNOW US MORE...</h1>
                                ...
                                >
                                  <SwiperSlide>
                                    <div className='w-full h-full p-4'>
                                        <h1 className='font-Comme font-black text-[1.2em] py-4 border-b-[1px] border-black tracking-wider px-3'>Craftsmanship and Quality</h1>
                                        <p className='font-Poppins p-2 tracking-wide text-justify'>At <span className=' font-semibold'>MAUI</span>, we take pride in the meticulous craftsmanship that goes into each bottle of our perfume.
                                  ...
                                  <SwiperSlide>
                                  <div className=' w-full h-full p-4 '>
                                        <h1 className='font-Comme font-black text-[1.2em] py-4 border-b-[1px] border-black tracking-wider px-3'>Our Vision</h1>
                                        <p className='font-Poppins p-2 tracking-wide text-justify'>Our vision at <span className=' font-semibold'>MAUI</span> is to be more than just a fragrance brand. We aspire to be a source of inspiration,
                                  ...
                                  <SwiperSlide>
                                    <div className=' w-full h-full p-4'>
                                          <h1 className='font-Comme font-black text-[1.2em] py-4 border-b-[1px] border-black tracking-wider px-3'>Commitment to Sustainability</h1>
                                          <p className='font-Poppins p-2 tracking-wide text-justify'>We believe in responsible perfumery. <span className=' font-semibold'>MAUI</span> is committed to sustainability,
                                  ...
                                  <SwiperSlide>
                                    <div className=' w-full h-full p-4'>
                                          <h1 className='font-Comme font-black text-[1.2em] py-4 border-b-[1px] border-black tracking-wider px-3'>Join Us on the Olfactory Journey</h1>
                                          <p className='font-Poppins p-2 tracking-wide text-justify'>
