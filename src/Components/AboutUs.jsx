    ...
    <div id="AboutUs" className='w-screen h-fit flex justify-center items-center bg-zinc-200'>
                ...
                <div className='h-full w-full md:w-3/4 flex flex-col items-center py-[4em] px-[2em] gap-4'>
                      ...
                      <div className=' w-full h-fit p-4 font-Comme'>
                            <p className='text-justify py-[1em] tracking-wide md:text-[1.4em] md:leading-loose'>Welcome to ETHEREAL MAJESTY, where we believe in the artistry of scent and the power of elegance.
                                ...
                                >
                                  <SwiperSlide>
                                    <div className='w-full h-full p-4'>
                                        ...
                                        <p className='font-Poppins p-2 tracking-wide text-justify md:text-[1.4em] md:py-[2em] md:leading-loose'>At <span className=' font-semibold'>ETHEREAL MAJESTY</span>, we take pride in the meticulous craftsmanship that goes into each bottle of our perfume.
                                  ...
                                  <div className=' w-full h-full p-4 '>
                                        ...
                                        <p className='font-Poppins p-2 tracking-wide text-justify md:text-[1.4em] md:py-[2em] md:leading-loose'>Our vision at <span className=' font-semibold'>ETHEREAL MAJESTY</span> is to be more than just a fragrance brand. We aspire to be a source of inspiration,
                                  ...
                                  <SwiperSlide>
                                    <div className=' w-full h-full p-4'>
                                          ...
                                          <p className='font-Poppins p-2 tracking-wide text-justify md:text-[1.4em] md:py-[2em] md:leading-loose'>We believe in responsible perfumery. <span className=' font-semibold'>ETHEREAL MAJESTY</span> is committed to sustainability,
                                  ...
                                  <SwiperSlide>
                                    <div className=' w-full h-full p-4'>
                                          ...
                                          <p className='font-Poppins p-2 tracking-wide text-justify md:text-[1.4em] md:py-[2em] md:leading-loose'>
                                            Discover the world of <span className=' font-semibold'>ETHEREAL MAJESTY</span> and explore our range of perfumes that
                                            ...
                                            <span className=' font-semibold'> ETHEREAL MAJESTY</span> invites you to indulge in the art of fragrance.
                                            <br></br>
                                            <br></br>
